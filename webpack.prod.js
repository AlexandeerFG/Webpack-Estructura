...
module.exports = {
    ...
    mode: 'production',   //-- este cambio afecta directamente a la minificación del archivo main.js
    ...
    optimization: {
        minimize: true,   
        minimizer: [
            new CssMinimizer(), //-- instancias de plugins que minimiza los archivos de css y html
            new Terser()
        ]
    },
